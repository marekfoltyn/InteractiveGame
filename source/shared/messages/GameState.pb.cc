...
void protobuf_AssignDesc_protobuf_2fGameState_2eproto() {
  protobuf_AddDesc_protobuf_2fGameState_2eproto();
  const ::google::protobuf::FileDescriptor* file =
    ::google::protobuf::DescriptorPool::generated_pool()->FindFileByName(
      "protobuf/GameState.proto");
  ...
  GameState_State_descriptor_ = GameState_descriptor_->enum_type(2);
}
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_protobuf_2fGameState_2eproto);
}
...
void protobuf_AddDesc_protobuf_2fGameState_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\030protobuf/GameState.proto\"\327\002\n\tGameState"
    "\022\014\n\004name\030\001 \001(\t\022*\n\010duration\030\002 \001(\0162\030.GameS"
    "tate.MatchDuration\022\'\n\tpitchSize\030\003 \001(\0162\024."
    "GameState.PitchSize\022\037\n\005state\030\004 \001(\0162\020.Gam"
    "eState.State\":\n\tPitchSize\022\016\n\nSIZE_SMALL\020"
    "\000\022\017\n\013SIZE_MEDIUM\020\001\022\014\n\010SIZE_BIG\020\002\"K\n\rMatc"
    "hDuration\022\022\n\016DURATION_SHORT\020\000\022\023\n\017DURATIO"
    "N_MEDIUM\020\001\022\021\n\rDURATION_LONG\020\002\"=\n\005State\022\017"
    "\n\013STATE_LOBBY\020\000\022\021\n\rSTATE_RUNNING\020\001\022\020\n\014ST"
    "ATE_PAUSED\020\002", 372);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "protobuf/GameState.proto", &protobuf_RegisterTypes);
  GameState::default_instance_ = new GameState();
  GameState::default_instance_->InitAsDefaultInstance();
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_protobuf_2fGameState_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_protobuf_2fGameState_2eproto {
  StaticDescriptorInitializer_protobuf_2fGameState_2eproto() {
    protobuf_AddDesc_protobuf_2fGameState_2eproto();
  }
} static_descriptor_initializer_protobuf_2fGameState_2eproto_;
...
#ifndef _MSC_VER
const GameState_State GameState::STATE_LOBBY;
const GameState_State GameState::STATE_RUNNING;
const GameState_State GameState::STATE_PAUSED;
...
const GameState& GameState::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_protobuf_2fGameState_2eproto();
        ...
        if (tag == 32) {
         parse_state:
          ...
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                   int, ::google::protobuf::internal::WireFormatLite::TYPE_ENUM>(
                 input, &value)));
          if (::GameState_State_IsValid(value)) {
            set_state(static_cast< ::GameState_State >(value));
          } else {
